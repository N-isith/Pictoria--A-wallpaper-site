        ...
        <div className="">
            ...
            <div>
                <ul className="flex justify-center gap-10 font-bold text-neutral-100 text-lg">
                    ...
                    <li className="hover:text-emerald-600 hover:duration-200"><a href="/help">Help</a></li>
                </ul>
            </div>
            ...
            <div>
                <div>
                    <ul className="flex justify-center gap-10 font-bold text-neutral-100 text-3xl">
                        <li className="hover:text-emerald-600 hover:duration-200"><a href="https://www.facebook.com/"><FaSquareFacebook /></a></li>
                        <li className="hover:text-emerald-600 hover:duration-200"><a href="https://www.instagram.com/"><FaInstagram /></a></li>
                        <li className="hover:text-emerald-600 hover:duration-200"><a href="https://www.whatsapp.com/"><FaWhatsapp /></a></li>
                        <li className="hover:text-emerald-600 hover:duration-200"><a href="https://x.com"><BsTwitterX /></a></li>
                    </ul>
                </div>
            </div>
